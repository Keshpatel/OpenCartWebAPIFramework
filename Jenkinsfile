...
pipeline {
    ...
    stages {
        ...
        stage('UAT - Sanity Tests') {
            ...
            post {
                always {
                    sh 'mkdir -p reports-uat/html reports-uat/allure'
                    sh 'cp -r qa-tests/reports/html-report/* reports-uat/html/ || true'
                    sh 'allure generate qa-tests/allure-results --clean -o reports-uat/allure || true'
                    publishHTML(target: [
...
🔍 <${env.BUILD_URL}console|View Console Logs>
                ...
                // Email Notification
                emailext(
                    to: 'kdpatel8184@gmail.com','naveenanimation20@gmail.com',
